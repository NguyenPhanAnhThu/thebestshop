				...
				<div class="panel-body">
					...
					<form:form action="admin/product/create.htm" modelAttribute="form" enctype="multipart/form-data">
						<div class="form-group">
							...
							<form:input path="name" class="form-control" id="ten_sp" placeholder="Tên sản phẩm" />
							<form:errors path="name"></form:errors>
						</div>
						<div class="form-group">
							<label for="dongia">Đơn giá</label>
							<form:input path="unitPrice" class="form-control" id="dongia" placeholder="Đơn giá" />
						...
						<div class="form-group">
							...
							<input name="_photo" class="file" type="file" multiple=true>
							<form:hidden path="image"/>
							<form:errors path="image"></form:errors>
						</div>
						<!-- <div class="form-group">
							<label for="hinh_anh">Hình ảnh</label>
							<form:input path="image" type="file" class="file" multiple="true"/>
						</div>-->
						<div class="form-group">
							<label for="datepicker">Ngày nhập hàng</label>
							<form:input path="productDate" type="text" id="datepicker" />
