...
<%@ page pageEncoding="utf-8"%>
            ...
            <div class="header-section">
               ...
               <!-- <div class="icon-logo dark-logo-bg hidden-xs hidden-sm">
                    <a href="index.html">
                        <img src="./resource/img/footerLogo3.png" alt="">-->
                        <!--<i class="fa fa-maxcdn"></i>-->
                  <!--  </a>
                </div>-->
                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            ...
                                            <ul class="col-sm-3 list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="./resource/img/mega-menu/mega_icon1.png" alt="" />
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="./resource/img/mega-menu/mega_icon2.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Amaging Dashboard</span>
                                                                <span class="d-desk">Build with BS3</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="./resource/img/mega-menu/mega_icon3.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">3500+ Satisfied Client</span>
                                                                <span class="d-desk">Max 5 star rating</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="./resource/img/mega-menu/mega_icon4.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Easy to Cutomize</span>
                                                                <span class="d-desk">Very easy to use</span>
                                                                </span>
                        ...
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> English  <b
                            ...
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> German </span><img src="./resource/img/flags/germany_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Italian </span> <img src="./resource/img/flags/italy_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> French </span> <img src="./resource/img/flags/french_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Spanish </span> <img src="./resource/img/flags/spain_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Russian </span> <img src="./resource/img/flags/russia_flag.jpg" alt=""/></a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="notification-menu">
                        ...
                        <li>
                            <a href="javascript:;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <img src="./resource/img/avatar-mini.jpg" alt="">John Doe
